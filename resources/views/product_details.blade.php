                ...
                <div class="small-img-row">
                    @if(isset($images[0]))
                        <div class="small-img-col">
                            <img src="{{ asset($images[0])}}" height="70" width="100%"  class="small-img">
                        </div>
                    @endif
                    @if(isset($images[1]))
                        <div class="small-img-col">
                            <img src="{{ asset($images[1])}}" height="70" width="100%"  class="small-img">
                        </div>
                    @endif
                    @if(isset($images[2]))
                        <div class="small-img-col">
                            <img src="{{ asset($images[2])}}" height="70" width="100%"  class="small-img">
                        </div>
                    @endif
                    @if(isset($images[3]))
                        <div class="small-img-col">
                            <img src="{{ asset($images[3])}}" height="70" width="100%"  class="small-img">
                        </div>
                    @endif
                </div>
